...
//	m_ComponentManager->AddComponent<TransformComponent>(0, 0,1, 32, 32, 4, 5);
...
//}
//
//void Pawn::InitComponents(float xPos, float yPos, float direction, int width, int height, float scale, float speed, float xVel, float yVel, float health, float damage)
//{
//	m_ComponentManager = std::make_unique<ComponentManager>();
//
